...
const Txo$json = const {
  '1': 'Txo',
  '2': const [
    const {'1': 'transactionOutput', '3': 1, '4': 1, '5': 11, '6': '.co.topl.brambl.models.transaction.UnspentTransactionOutput', '8': const {}, '10': 'transactionOutput'},
    const {'1': 'state', '3': 2, '4': 1, '5': 14, '6': '.co.topl.genus.services.TxoState', '10': 'state'},
    const {'1': 'outputAddress', '3': 3, '4': 1, '5': 11, '6': '.co.topl.brambl.models.TransactionOutputAddress', '8': const {}, '10': 'outputAddress'},
  ],
};

/// Descriptor for `Txo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List txoDescriptor = $convert.base64Decode('');
...
const AssetLabel_V1Label$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mintingAddress', '3': 2, '4': 1, '5': 11, '6': '.co.topl.brambl.models.LockAddress', '8': const {}, '10': 'mintingAddress'},
  ],
};
...
final $typed_data.Uint8List assetLabelDescriptor = $convert.base64Decode('');
